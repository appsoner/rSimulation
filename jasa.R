...
screen(1) 
plot(tmp2, tmp3, ylim = c(min(tlb1),max(tub1)), type="l", col = "blue", xlab = " TOPTEN ", ylab = " ", cex = 0.7, cex.axis = 0.85)
lines(tmp2, tlb1,  lty=2, col = "dark grey")
lines(tmp2, tub1,  lty=2, col = "dark grey")

screen(2) 
plot(tmp5, tmp6, ylim = c(min(tlb2),max(tub2)), type="l", col = "blue", xlab = " Log(Assets) ", ylab = " ", cex = 0.7, cex.axis = 0.85)
