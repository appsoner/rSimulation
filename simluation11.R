...
plot(tmp5, tmp6, ylim = c(min(tlb2),max(tub2)), type="l", col = "blue", xlab = expression(paste("2",pi,t[ij])), ylab = expression("sin()"), cex = 0.7, cex.axis = 0.85, lwd = 2)
